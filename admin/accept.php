...
$query1="SELECT * FROM `reservations_enquries` where id = '$id'";
...
$subject="Booking Approved";
$body="Your booking has been approved by the management<br>Regards,<br>HILL SIDE";
$headers="From:hillside407@gmail.com";
if(mail($mail,$subject,$body,$headers))
{
	echo "Mail sent";
}
$query="UPDATE `reservations_enquries` SET  status='Accepted' where id = '$id'";
