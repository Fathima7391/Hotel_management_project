...
<body >
	<div id="mySidenav" class="sidenav" >
		...
		<a href="requests.php" class="admin-items one-top" target="content">Room Booking</a>
		<a href="requests_events.php" class="admin-items one-top" target="content">Event Booking</a>
		<a href="add_room.php" class="admin-items one-top" target="content">Add Room</a>
		<a href="add_service.php" class="admin-items one-top" target="content">Add Service</a>
		<a href="user_details.php" class="admin-items one-top" target="content">View User Details</a>
